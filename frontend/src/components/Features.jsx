    ...
    <div ref={featuresRef} className="bg-transparent py-20 relative z-10">
      <div className="container mx-auto text-center px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <div className="bg-white/90 backdrop-blur-sm border-blue-500 border-l-8 rounded-xl p-6 shadow-lg flex flex-col justify-center hover:transform hover:scale-105 transition-all duration-300">
